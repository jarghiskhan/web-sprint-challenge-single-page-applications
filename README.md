...
1. In 1-2 sentences, explain what React's `useRouteMatch` hook is used for.
    --useRouteMatch is used to get the data assigned to match without using <Route>. 

1. How would you explain form validation to someone who has never programmed before?
    --It prevents the user from sending invalid data to the server. E.g. If a patient was applying to a hospital and only puts 2 numbers in the phone number field, it will alert that user before they submit letting them know that they need to put their full phone number in the field.

1. In 1-2 sentences, define end to end testing.
    --Testing application behavior from beginning to end to simulate what a user might do. 
